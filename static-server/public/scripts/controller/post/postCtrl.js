    ...
    function ($scope, $element, $routeParams, $rootScope, $location, $popbox, o, $modal, isLengthOKFilter, $window, wtPrompt, $http, googleIP) {
            ...
            $scope.permission === kzi.constant.permission.ok && $rootScope.project.info.curr_role !== kzi.constant.role.guest && ($scope.pop_member_options = [
                {
                    ...
                    click: function (t, i, a, s) {
                        a.assigned = !0, wt.bus.member.set_post_member_toggle(r, $scope.post, a, function () {
        ...
        var c1, u1 = function (e, t, i) {
            ...
            if (names.indexOf(a) == -1) {
                wt.data.post.add_tag(r, l, a, function (t) {
                    e.tags = e.tags || [];
                    e.tags.push(t.data)
                }, null, function () {
                    _.isFunction(i) && i()
        ...
        $scope.post = {}, $scope.$on(kzi.constant.event_names.on_slide_hide, function () {
            ...
            _.isEmpty($scope.post.temp_price) || (n.temp_price = $scope.post.temp_price),
            _.isEmpty($scope.post.temp_count) || (n.temp_count = $scope.post.temp_count),
            $scope.post = n          
        }),
		 ...
		 */
            $scope.$on(kzi.constant.event_names.load_entity_post, function (t, i) {
                 (r = $scope.pid = i.pid, l = i.post_id, $scope.select_tab_comment(),
                    ...
                    $rootScope.load_post(r, l, function (t, n) {
                        ...
                        $scope.post && $scope.post.post_id === n.post_id &&
                        (_.isEmpty($scope.post.temp_name) || (n.temp_name = $scope.post.temp_name),
                            _.isEmpty($scope.post.temp_title) || (n.temp_title = $scope.post.temp_title),
                            _.isEmpty($scope.post.temp_enName) || (n.temp_enName = $scope.post.temp_enName),
                            _.isEmpty($scope.post.temp_cnName) || (n.temp_cnName = $scope.post.temp_cnName),
                            ...
                            !$scope.$$phase, _.isEmpty(n.files) ? wt.data.file.get_attach_list(r, "posts", l, function (e) {
                ...
                controller: ["$scope", "popbox", "pop_data",
                    function (e, t) {
                        ...
                        e.js_delete_post = function () {
                            e.is_saving = true;
                            $rootScope.del_entity(i.eid, i.uid, "post", null, function (){
                                e.is_saving = false;
                                $rootScope.locator.hide_slide();
                                t.close();
                                $rootScope.$broadcast(kzi.constant.event_names.on_post_trash, {eid: i.eid});
                            });
                        }
                    }
                ],
        ...
        $scope.js_archive = function () {
            ...
            _.isEmpty(i) || i.post_id === $scope.post.post_id && ($scope.post.completed = i.completed)
        }),
        ...
        $scope.$on(kzi.constant.event_names.on_post_comment, function (t, i) {
            _.isEmpty(i) || i.post_id !== $scope.post.post_id || ($scope.post.badges.comment_count += 1, $rootScope.$broadcast(kzi.constant.event_names.on_post_update, $scope.post))
        }), $scope.$on(kzi.constant.event_names.on_post_mail, function (t, i) {
            _.isEmpty(i) || i.post_id !== $scope.post.post_id || ($scope.post.badges.mail_count += 1, $rootScope.$broadcast(kzi.constant.event_names.on_post_update, $scope.post))
        }), $scope.$on(kzi.constant.event_names.on_post_badges_file, function (t, i) {
            i && "post" === i.type && $scope.post.post_id === i.file.formData.post_id && (_.isArray($scope.post.files) ? $scope.post.files.push(i.file) : $scope.post.files = [i.file], _.isArray($scope.post.files) && ($scope.post.badges.file_count = $scope.post.files.length))
            ...
            if (t.is_saving !== !0) {
                ...
                t.is_saving = !0,
                wt.data.post.update(l, t, function (response) {
                    t.is_edit = !1,
                        t.name = t.temp_name,
        ...
        $scope.js_show_tag = function (e) {
            ...
            }), wt.data.post.remove_tag(r, l, t.tag_id, function () {
                        ...
                        e.popbox = t, e.post = i, $rootScope.load_project_members(r, function (t) {
                            ...
                            if (e.is_watch) {
                                ...
                                t && (i.watchers = _.reject(i.watchers, function (t) {
                                    return t.uid === e.uid
                                })), e.is_watch = 0, wt.data.unwatch(r, kzi.constant.xtype.post, i.post_id, e.uid, function () {
                                })
                            } else {
                                var t = _.findWhere(i.watchers, {
                                    uid: e.uid
                                });
                                t || (i.watchers.push(e), e.is_watch = 1, wt.data.watch(r, kzi.constant.xtype.post, i.post_id, e.uid, function () {
                                }))
                            }
                        }, e.js_watch_all = function () {
                            if (i.watchers.length !== e.members) {
                                var n = _.pluck(e.members, "uid");
                                wt.data.watch_batch(r, kzi.constant.xtype.post, i.post_id, n, function () {
            ...
            $popbox.popbox({
                ...
                controller: ["$scope", "popbox", "pop_data",
                    function (e, t, a) {
            	    if (_.isEmpty(tagtype)) tagtype='post';
                        ...
                        e.js_toggle_tag = function (e) {
                            if (e.assigned) {
                                ...
                                })), e.assigned = 0, wt.data.post.remove_tag(r, l, e.tag_id, function () {
                                })
                            } else {
                                var t = _.findWhere(a.scope.post.tags, {
                                    tag_id: e.tag_id
                    ...
                    function (e, t) {
                        e.popbox = t, e.js_step = function (t) {
                            ...
                            if (1 == t.type) e.step = 1, e.prj_files_loaded = !1, e.sub_files = [], $rootScope.load_files(r, t.fid, function (i) {
                                ...
                                a || (i.files.push(t), wt.data.file.attach(r, "posts", l, t.fid, function () {
                    ...
                    function (e, t) {
                        e.popbox = t, e.js_close = function () {
                            ...
                            _.each(e.entries, function (e) {
                                e.selected = 0
                            }), a.selected = 1, wt.data.post.unarchive(i.pid, i.post_id, a.entry_id, function () {
            ...
            t && !_.isEmpty(t) && ($scope.file_upload_option = {
                ...
                return $rootScope.upload_queue.get_mail_post(t.pid, t.post_id)
            ...
            i && 'post' === i.type && $scope.post.post_id === i.file.formData.post_id && (_.isArray($scope.post.files) ? $scope.post.files.push(i.file) : $scope.post.files = [i.file]);
            ...
            a && ($scope.post.files = _.reject($scope.post.files, function (e) {
                return e.fid == i.fid
            })), wt.data.file.detach(r, "posts", l, i.fid), $rootScope.$broadcast(kzi.constant.event_names.on_post_update, $scope.post)
