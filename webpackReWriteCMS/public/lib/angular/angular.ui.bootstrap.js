...
angular.module('ui.bootstrap.pagination', [])
    ...
    .directive('pagination2', ['$parse', 'paginationConfig', '$location', function ($parse, paginationConfig, $location) {
        return {
            restrict: 'EA',
            scope: {
                totalItems: '=',
            ...
            require: ['pagination2', '?ngModel'],
            controller: 'PaginationController',
            templateUrl: 'template/pagination/pagination2.html',
            replace: true,
            link: function (scope, element, attrs, ctrls) {
 ...
 */
    .provider('$tooltip0', function () {
         ...
         * application.
         *
         *   var app = angular.module( 'App', ['ui.bootstrap.tooltip'], function( $tooltip0Provider ) {
   *     // place tooltips left instead of top by default
   *     $tooltip0Provider.options( { placement: 'left' } );
   *   });
         */
         ...
         *
         *   $tooltip0Provider.setTriggers( 'openTrigger': 'closeTrigger' );
         */
        ...
        /**
         * Returns the actual instance of the $tooltip0 service.
         * TODO support multiple triggers
         */
        this.$get = [ '$window', '$compile', '$timeout', '$parse', '$document', '$position', '$interpolate', function ($window, $compile, $timeout, $parse, $document, $position, $interpolate) {
            return function $tooltip0(type, prefix, defaultTriggerShow) {
                 ...
                 * option passed to the `$tooltip0Provider.options` method; else it will
                 * default to the trigger supplied to this directive factory.
                 *
                 * The hide trigger is based on the show trigger. If the `trigger` option
                 * was passed to the `$tooltip0Provider.options` method, it will use the
    ...
    .directive('tooltip', [ '$tooltip0', function ($tooltip0) {
        return $tooltip0('tooltip', 'tooltip', 'mouseenter');
    }])
    ...
    .directive('tooltipHtmlUnsafe', [ '$tooltip0', function ($tooltip0) {
        return $tooltip0('tooltipHtmlUnsafe', 'tooltip', 'mouseenter');
    }]);
...
angular.module('ui.bootstrap.popover', [ 'ui.bootstrap.tooltip' ])
    ...
    .directive('popover', [ '$tooltip0', function ($tooltip) {
