...
angular.module('mgcrea.ngStrap.popover').run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put('/view/directive/hint_once.html', '<div class="popover tooltip_over" style="top:30px;opacity: 1"><div class="arrow"></div><h3 class="popover-title" ng-bind="title" ng-show="title"></h3><div class="popover-content" ng-bind="content" style="padding-right: 20px"></div>    <i class="icon-close" style="color: #000; top:12px; right: 5px;opacity: 0.2" ng-click="hide()"></i></div>');
